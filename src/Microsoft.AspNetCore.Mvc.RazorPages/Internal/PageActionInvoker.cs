    ...
    public class PageActionInvoker : ResourceInvoker, IActionInvoker
    {
        ...
        private async Task InvokeHandlerMethodAsync()
        {
            ...
            if (_handler != null)
            {
                ...
                var argsHack = new Dictionary<string, object>();
                _diagnosticSource.BeforeHandlerMethod(_pageContext, handler, argsHack, _instance);
                ...
                {
                    _diagnosticSource.AfterHandlerMethod(_pageContext, handler, argsHack, _instance, _result);
                }
            }
